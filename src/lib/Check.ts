 ...
 */
export async function CheckWords(key: string | string[]): Promise<boolean[]> {
 ...
 */
export async function CheckTerms(key: string | string[]): Promise<boolean[]> {
  if(!Array.isArray(key)) key = [key];
  ...
  */
 export async function CheckSays(key: string | string[]): Promise<boolean[]> {
  if(!Array.isArray(key)) key = [key];
  ...
  */
 export async function CheckName(key: string | string[]): Promise<boolean[]> {
  if(!Array.isArray(key)) key = [key];
